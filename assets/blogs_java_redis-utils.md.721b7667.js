import{_ as t,C as o,c,H as s,k as p,w as l,a as n,Q as r,o as y}from"./chunks/framework.b0840c63.js";const C=JSON.parse('{"title":"Redis utils文件","description":"","frontmatter":{"title":"Redis utils文件","layout":"doc"},"headers":[],"relativePath":"blogs/java/redis-utils.md","filePath":"blogs/java/redis-utils.md","lastUpdated":1697914235000}'),E={name:"blogs/java/redis-utils.md"},i=p("h1",{id:"redis-utils文件",tabindex:"-1"},[n("Redis utils文件 "),p("a",{class:"header-anchor",href:"#redis-utils文件","aria-label":'Permalink to "Redis utils文件"'},"​")],-1),A={style:{display:"flex",gap:"10px"}},D=r(`<h2 id="在项目启动目录创建-utils-rediscache-java" tabindex="-1">在项目启动目录创建 utils -&gt; RedisCache.java <a class="header-anchor" href="#在项目启动目录创建-utils-rediscache-java" aria-label="Permalink to &quot;在项目启动目录创建 utils -&gt; RedisCache.java&quot;">​</a></h2><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> java.util.Collection;</span></span>
